...
$sqlrs = mysqli_query(
    $koneksi,
    "SELECT kd_penyakit FROM penyakit_solusi WHERE kd_penyakit='$kd_penyakit'"
);
$rs = mysqli_num_rows($sqlrs);
if ($rs == 0) {
    $perintah = "INSERT INTO penyakit_solusi(kd_penyakit,nama_penyakit,jenis_penyakit,definisi,solusi)VALUES('$kd_penyakit','$nama_penyakit','$jenis_penyakit','$definisi','$solusi')";
