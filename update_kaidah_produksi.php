...
$queryDel = mysqli_query(
    $koneksi,
    "DELETE  FROM relasi WHERE kd_penyakit='$kd_penyakit' "
);
...
for ($start = 0; $start < count($text_line); $start++) {
    ...
    // $sqlCekRelasi = mysqli_query('SELECT * FROM ');
    $sql = "INSERT INTO  relasi (kd_gejala,kd_penyakit) VALUES ('$baris','$kd_penyakit')";
